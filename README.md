...
<img src="images/GuardGroq (1861 x 625 px).png" alt="GuardGroq: LLaMA Guard-Powered Content Shield Logo" width="940" height="310"/>


## How It Works

GuardGroq moderates content using LLaMA Guard 4 and Groq's LPU technology, following these steps:
1. User Input: Receives the user's utterance as input.
2. Rapid Classification: Uses LLaMA Guard 4 to classify the input as safe or unsafe.
4. Safe Content Handling: If safe, passes the original utterance as output.
...
- Utilizes the latest llama-guard-4-12b
